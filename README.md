...
4. Install hack-clock via `wget https://github.com/deckerego/hack-clock/releases/download/2.1.1/python-hackclock_2.1.2-1_all.deb; sudo dpkg -i python-hackclock_2.1.2-1_all.deb`
