...
4. Install hack-clock via `wget https://github.com/deckerego/hack-clock/releases/download/2.0-PRE-2/python-hackclock_2.0-pre-2_all.deb; sudo dpkg -i python-hackclock_2.0-pre-2_all.deb`
